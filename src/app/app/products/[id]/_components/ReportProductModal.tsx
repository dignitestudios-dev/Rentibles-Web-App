...
export interface ReportProductModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (reasonId: string, details?: string) => void | Promise<void>;
...
const ReportProductModal: React.FC<ReportProductModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const result = onSubmit(selectedReason, otherReason.trim());
